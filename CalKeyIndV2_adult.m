function [T2,Yv,ci,deltar2] = CalKeyIndV2_adult(dif,con,test_result,temp_all,hct_all,nlist)
...
%             figure;
    ...
    %     display_fmri(anat,mask);
        ...
        ci_c=aa_c(2,:);
        Yv(ii)=prox_invitroblood_batch_R2vsyandhct_Golay2001_oneHct50_1(t2,hct_all(ii));
        T2(ii) = t2;
