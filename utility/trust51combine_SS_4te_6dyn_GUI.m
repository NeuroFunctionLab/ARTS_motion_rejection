function [t2,ci,Yv]=trust51combine_SS_4te_6dyn_GUI(filename1,matrix,seq,hct)
...
for i=1:length(seq)
    ...
    write_ANALYZE(noalign(:,:,i),tempstr1,[64 64 1], [3.44 3.44 5], 1,16);
...
otherwise
    ...
    source=strcat(tempstr,filesep,'img_', a, '.img');
    other=source;
    spm_defaults;
